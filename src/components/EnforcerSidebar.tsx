...
const navigation = [
  { to: "/enforcer", label: "New citation", icon: PlusCircle },
...
export function EnforcerSidebar() {
  return (
    <nav
      ...
      className="sticky top-6 overflow-hidden rounded-2xl border border-sidebar-border/60 bg-authority p-2 shadow-lift"
    >
